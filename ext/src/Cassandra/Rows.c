...
{
  cassandra_rows *self = PHP5TO7_ZEND_OBJECT_GET(cassandra_rows, object);
...
{
  cassandra_rows *self =
      PHP5TO7_ZEND_OBJECT_ECALLOC(cassandra_rows, ce);
  ...
  PHP5TO7_ZEND_OBJECT_INIT(cassandra_rows, self, ce);
}
